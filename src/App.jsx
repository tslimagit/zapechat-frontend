...
function AutomationsPage(){
  ...
  const platforms=[{id:"hotmart",label:"Hotmart"},{id:"eduzz",label:"Eduzz"},{id:"kiwify",label:"Kiwify"},{id:"voomp",label:"Voomp"},{id:"guru",label:"Guru"},{id:"activecampaign",label:"ActiveCampaign"}];
  const events=[
